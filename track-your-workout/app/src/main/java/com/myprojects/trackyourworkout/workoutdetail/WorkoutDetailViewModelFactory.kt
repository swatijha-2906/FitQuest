 ...
 *
 * Provides the key for the night and the workoutDatabaseDao to the ViewModel.
 */
class WorkoutDetailViewModelFactory(
        private val workoutDayKey: Long,
    ...
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(WorkoutDetailViewModel::class.java)) {
            return WorkoutDetailViewModel(workoutDayKey, dataSource) as T
        }
