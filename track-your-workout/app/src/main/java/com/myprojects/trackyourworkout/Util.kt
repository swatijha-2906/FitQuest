...
package com.myprojects.trackyourworkout
...
/**
 * Takes a list of workoutNights and converts and formats it into one string for display.
 *
 * For display in a TextView, we have to supply one string, and styles are per TextView, not
 * applicable per word. So, we build a formatted string using HTML. This is handy, but we will
 * learn a better way of displaying this data in a future lesson.
 *
 * @param   nights - List of all workoutNights in the database.
...
fun formatNights(nights: List<Workout>, resources: Resources): Spanned {
    ...
    sb.apply {
        ...
        nights.forEach {
            ...
            if (it.endTimeMilli != it.startTimeMilli) {
                ...
                append("\t${convertNumericQualityToString(it.workoutQuality, resources)}<br>")
