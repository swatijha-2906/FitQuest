...
class WorkoutQualityViewModelFactory(
    private val dayKey: Long,
    private val dataSource: WorkoutDatabaseDao) : ViewModelProvider.Factory {

    @Suppress("unchecked_cast")
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(WorkoutQualityViewModel::class.java)) {
            return WorkoutQualityViewModel(dayKey, dataSource) as T
        }
